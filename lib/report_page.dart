...
class _ReportState extends State<Report> {
  ...
  //
  //     try {
  //       await conn.execute('INSERT INTO enviromental_issues (status,location,reporter_id,title,description,category) VALUES (:status,:location,:reporter_id,:title,:description,:category)', {
  //             "status": 0,
  //             "location": location,
  ...
  //           }
  //       );
  //       print('Reporter ID: ${widget.userId}');
  ...
  //       );
  //     } catch (e) {
  //       print('Error while submitting the report: $e');
  //       ScaffoldMessenger.of(context).showSnackBar(
