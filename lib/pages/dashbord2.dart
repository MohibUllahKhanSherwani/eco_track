...
//                               children: [
//                                 info_container(
//                                     "Name: ${data['name']}", Icons.person),
//                                 info_container(
//                                     "Status: Online", Icons.task_alt),
//                                 info_container("Location: ${data['address']}",
//                                     Icons.location_on),
//                               ],
//                             );
//                           } else {
...
//   }
//
//   Container small_button_containers(IconData icon, VoidCallback onTap) {
//     return Container(
...
//   }
//
//   GestureDetector buttonsContainers(
//       String title, IconData icon, String uniqueId) {
...
class _DashboardState extends State<Dashboard2> {
  ...
  Container _buildMapCard(BuildContext context) {
    return Container(
      ...
      child: IssuePieChart(issuesCompleted: 10, issuesRemaining: 5),
    );
  }
